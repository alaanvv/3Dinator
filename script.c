...
i8 main() {
  ...
  glUniform3f(UNI(shader, "MAT.dif"), 0.99754,  0.99754,  0.99754);
  ...
  glUniform1f(UNI(shader, "LIG.l"), 0.007);
  glUniform1f(UNI(shader, "LIG.q"), 0.0002);
  glUniform1f(UNI(shader, "LIG.cutoff"), cos(0.21));
  glUniform1f(UNI(shader, "LIG.outer_cutoff"), cos(0.25));


  generate_proj_mat(cam, proj);
  generate_view_mat(cam, view);

  vec3 poss[78] = { {-6.00, 13.00, -9.00}, {5.00, 6.00, 10.00}, {-2.00, 11.00, 4.00}, {-9.00, 14.00, -6.00}, {1.00, 7.00, -5.00}, {0.00, 18.00, -3.00}, {-3.00, 5.00, 1.00}, {8.00, 14.00, 1.00}, {-2.00, 0.00, 6.00}, {0.00, 10.00, 6.00}, {-4.00, 1.00, -5.00}, {6.00, 2.00, 5.00}, {-9.00, 4.00, 8.00}, {-2.00, 12.00, -8.00}, {8.00, 11.00, 4.00}, {6.00, 15.00, -5.00}, {0.00, 1.00, -7.00}, {-10.00, 16.00, -3.00}, {-8.00, 7.00, 2.00}, {5.00, 7.00, 8.00}, {2.00, 13.00, 8.00}, {9.00, 6.00, -7.00}, {-1.00, 2.00, -8.00}, {4.00, 7.00, 4.00}, {-3.00, 1.00, 8.00}, {-2.00, 3.00, -3.00}, {5.00, 8.00, -9.00}, {9.00, 0.00, -1.00}, {-7.00, 7.00, -7.00}, {7.00, 2.00, 0.00}, {15.00, 3.00, -10.00}, {-12.00, -18.00, 11.00}, {17.00, -16.00, -18.00}, {-2.00, -5.00, 0.00}, {14.00, -7.00, -20.00}, {8.00, -1.00, 6.00}, {-18.00, 2.00, 3.00}, {-13.00, 11.00, -4.00}, {-5.00, -10.00, 18.00}, {9.00, 5.00, 2.00}, {10.00, -12.00, -10.00}, {6.00, 8.00, -15.00}, {-1.00, -8.00, 10.00}, {-6.00, -11.00, 10.00}, {12.00, -15.00, -12.00}, {14.00, -3.00, -2.00}, {-15.00, 20.00, 14.00}, {18.00, 14.00, 5.00}, {10.00, -5.00, -3.00}, {-7.00, -9.00, 10.00}, {-17.00, 15.00, -14.00}, {3.00, -6.00, -8.00}, {5.00, -20.00, -10.00}, {0.00, 10.00, -18.00}, {1.00, -13.00, 7.00}, {16.00, -4.00, -6.00}, {4.00, -14.00, -2.00}, {3.00, 7.00, -1.00}, {-20.00, -19.00, -8.00}, {10.00, -17.00, 7.00}, {-14.00, -2.00, -13.00}, {-15.00, 9.00, 19.00}, {-11.00, -16.00, 0.00}, {-19.00, 4.00, 16.00}, {19.00, -20.00, 1.00}, {13.00, 15.00, -9.00}, {7.00, -7.00, 10.00}, {-16.00, -15.00, -5.00}, {2.00, 16.00, -3.00}, {11.00, 12.00, 10.00}, {-4.00, -3.00, 11.00}, {16.00, -18.00, 9.00}, {20.00, -9.00, 16.00}, {-19.00, -20.00, -10.00}, {-6.00, 0.00, -8.00}, {12.00, 8.00, -14.00}, {-8.00, 17.00, 18.00}, {15.00, 1.00, -18.00} };
  ...
  while (!glfwWindowShouldClose(canvas.window)) {
    ...
    for (i8 i = 0; i < 77; i++) {
      glUniform3f(UNI(shader, "LIG.pos"), cam.pos[0], cam.pos[1], cam.pos[2]);
      glUniform3f(UNI(shader, "LIG.dir"), cam.dir[0], cam.dir[1], cam.dir[2]);
      glm_mat4_identity(model);
      glm_translate(model, poss[i]);
      if (i ==76) glm_scale(model, (vec3) { 5, 5, 5 });
